...
${OBJECTDIR}/sqlite-amalgamation-3080300/sqlite3.o: sqlite-amalgamation-3080300/sqlite3.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sqlite-amalgamation-3080300/sqlite3.o sqlite-amalgamation-3080300/sqlite3.c

${OBJECTDIR}/sqlite3pp/sqlite3pp.o: sqlite3pp/sqlite3pp.cpp 
	${MKDIR} -p ${OBJECTDIR}/sqlite3pp
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sqlite3pp/sqlite3pp.o sqlite3pp/sqlite3pp.cpp

${OBJECTDIR}/sqlite3pp/sqlite3ppext.o: sqlite3pp/sqlite3ppext.cpp 
	${MKDIR} -p ${OBJECTDIR}/sqlite3pp
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sqlite3pp/sqlite3ppext.o sqlite3pp/sqlite3ppext.cpp
