...
testing
gen_k_part_colex_init() and gen_k_part_colex_next()

compile
gcc -o k_part_colex_example k_part_colex_example.c k_part_colex.c
*/
...
set_counter = 0;
printf("k_part_colex(%u, %u)\n", n, k);

//initialize
gen_result = gen_k_part_colex_init(vector, n, k);
...
while(gen_result == GEN_NEXT)
 ...
 gen_result = gen_k_part_colex_next(vector, k);
 }
