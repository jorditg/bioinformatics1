...
testing
gen_comb_rep_revcolex_init() and gen_comb_rep_revcolex_next()

compile
gcc -o comb_rep_revcolex_example comb_rep_revcolex_example.c comb_rep_revcolex.c
*/
...
int main(void)
{
unsigned char n           = 3;    //length of alphabet
...
set_counter = 0;
printf("comb_rep_revcolex(%u, %u)\n", n, k);

//initialize
gen_result = gen_comb_rep_revcolex_init(vector, n, k);
...
while(gen_result == GEN_NEXT)
 ...
 gen_result = gen_comb_rep_revcolex_next(vector, k);
 }
