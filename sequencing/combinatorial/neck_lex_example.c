...
testing
gen_neck_lex_init() and gen_neck_lex_next()

compile
gcc -o neck_lex_example neck_lex_example.c neck_lex.c
*/
...
//initialize
gen_result = gen_neck_lex_init(vector, m, n);
...
while(gen_result == GEN_NEXT)
 ...
 gen_result = gen_neck_lex_next(vector, m, n);
 }
